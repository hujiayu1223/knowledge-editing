...
from minigpt4.Halle_Editor.prompt_tuning import prompt_tuning
...
parser.add_argument("--prompt", type=str, default="qu_halle")
...
con_id = []
con_img = {}
for img_id in tqdm(id_list[:100]):
    ...
    qu = {"qu_image": qu_image, "qu_halle": qu_halle_2,"qu_norm":qu_norm} 
    ...
    # with open(os.path.join(base_dir, 'kl_pairwise_1500.jsonl'), "a") as f:
...
save_path = f'{args.results_save_dir}/unlearn_llava-1500_pairwise_kl-chat'
# exit()
